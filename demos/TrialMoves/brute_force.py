...
if pid == 0:
	...
	class CustomSimulation(TpsTestPeSurf2dMC):
		...
		def callbackOnRunCommand(self):
			...
			if nt > 0:
				...
				tn.write("graphics 0 sphere {" + str(x) + " " + str(y) + " "  + str(z+0.150) + "} radius 0.01\n")
				...
				tn.write("graphics 0 sphere {" + str(x) + " " + str(y) + " "  + str(z+0.150) + "} radius 0.1\n")
	...
	class CustomPathSampling(TpsAlgorithmBruteForce):
